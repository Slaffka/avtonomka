...
$string['defaultcity'] = 'Default lm_city';
$string['defaultcity_help'] = 'A lm_city entered here will be the default lm_city when creating new user accounts.';
...
$string['geoipfile'] = 'GeoIP lm_city data file';
