 ...
 */
// begin custom version
$string['date'] = 'Date';
$string['feedback'] = 'Default';
$string['feedbacktype'] = 'Type';
$string['mysteryshopper'] = 'Mystery shopper';
$string['qualitycheck'] = 'Feedback';
$string['feedback:receivemail_checkquality'] = 'Send email if feedback "quality check"  submitted';
$string['feedback:receivemail_mysteryshopper'] = 'Send email if feedback "mystery shopper" submitted';
$string['emailmysteryshopperhtml'] = 'Has completed mystery shopper activity, please (<a href="{$a->url}">check results</a>)';
$string['emailmysteryshoppertext'] = 'Has completed mystery shopper activity, please check results {$a->url}';
$string['emailqualitycheckhtml'] = 'Has completed quality check feedback (<a href="{$a->url}">see results</a>)';
$string['emailqualitychecktext'] = 'Has completed quality check feedback, see results here {$a->url}';
$string['emailfeedbackhtml'] = 'Has completed feedback activity (<a href="{$a->url}">see results</a>)';
$string['emailfeedbacktext'] = 'Has completed feedback activity, see results here {$a->url}';
// end custom version
