...
class mod_feedback_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $options=array();
        $options['feedback']  = get_string('feedback', 'feedback');
        $options['mysteryshopper']  = get_string('mysteryshopper', 'feedback');
        $options['qualitycheck']  = get_string('qualitycheck', 'feedback');
        $mform->addElement('select',
            'type',
            get_string('feedbacktype', 'feedback'),
            $options);
        // end custom version
