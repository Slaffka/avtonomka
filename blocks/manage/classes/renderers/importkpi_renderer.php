...
class lm_kpi_import_form extends moodleform
{
    function definition()
    {
        $mform =& $this->_form;
...
class block_manage_importkpi_renderer extends lm_base_import
{
    /**
     * @var string
     */
    public $pageurl = '/blocks/manage/?_p=importkpi';
    public $pagename = 'Импорт KPI';
    public $type = 'manage_importkpi';
    ...
    public function main_content() {
        ...
        $form = new lm_kpi_import_form($this->pageurl);
        if ($form->is_submitted() && $form->is_validated()) {
            ...
            if ($this->file instanceof stored_file) {
                ...
                $importer = new lm_kpi_import($this->file);
        ...
        return $this->fetch('importkpi/index.tpl');
    }
