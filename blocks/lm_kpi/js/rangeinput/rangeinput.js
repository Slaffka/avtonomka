...
//{{{ fn.drag
	...
	*/
	...
	$.fn.drag = function(conf) {
		...
		doc = doc || $(document).on("touchstart mousedown mouseup", function(e) {
			...
			if ( (e.type == "mousedown" || e.type == "touchstart") && el.data("drag")) {
				...
				var offset = el.position(),
					 x0 = pagePos.x - offset.left,
					 y0 = pagePos.y - offset.top,
					 start = true;    
				
				doc.on("touchmove mousemove.drag", function(e) {
                    var pagePos = getPagePos(e);

                    console.log("move", pagePos.x, pagePos.y);
					var x = pagePos.x -x0,
						 y = pagePos.y -y0,
						 props = {};
