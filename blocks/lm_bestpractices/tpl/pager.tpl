            ...
            <ul>
                ...
                {else}
                    ...
                    {if $pager_start > 1}
                        {if $pager_start > 2}
                            <li class="start">
                                <a href="{$pager->url}&page=1" data-page="1" style="margin-right: 17px;"><<</a>
                            </li>
                        {/if}
                        <li>
                            <a href="{$pager->url}&page={$pager_start - 1}" data-page="{$pager_start - 1}"><</a>
                        </li>
                    {/if}
                {/if}
                ...
                {for $i = $pager_start ; $i <= $pager_end; $i++}
                    ...
                    {else}
                        <li>
                            <a href="{$pager->url}&page={$i}" data-page="{$i}">{$i}</a>
                        </li>
                    {/if}
                {/for}
                {if $pager_end < $pager->count}
                    <li>
                        <a href="{$pager->url}&page={$pager_end + 1}" data-page="{$pager_end + 1}">></a>
                    </li>
                    <li class="end">
                        <a href="{$pager->url}&page={$pager->count}" style="margin-left: 17px;" data-page="{$pager->count}">>></a>
                    </li>
                {/if}
            </ul>
        </div>
