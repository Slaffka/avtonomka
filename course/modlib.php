 ...
 * @param boolean $reset_completion_data - if it is set to false - completion data will not be wiped
 * @return array list of course module and module info.
 */
function update_moduleinfo($cm, $moduleinfo, $course, $mform = null, $reset_completion_data = true) {
    global $DB, $CFG;
    ...
    if ($completion->is_enabled() && !empty($moduleinfo->completionunlocked) && $reset_completion_data === true) {
